    ...
    <div class="row">
        <div class="col-sm-3 bg-drop-grad" v-cloak>
            ...
            <div class="row col-sm-12">
                <h1 class="text-second" v-text="'Block '+ itemID"></h1>
            </div>
        ...
        <div class="col-sm-12 pull-right">
            ...
            <nav>
                <ul>
                    <li>Summary</li>
                    <li><i class="glyphicon glyphicon-transfer" style="font-size: 0.7em; margin-right: 5px"></i> {{ txList.length }} Transactions
                    </li>
                    <li><i class="glyphicon glyphicon-export" style="font-size: 0.7em; margin-right: 5px"></i> {{ totalSenders }} Senders
                    </li>
